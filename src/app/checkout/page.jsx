    ...
    return (
      <ProtectedRoute>
        <div className="pb-20 max-w-md mx-auto text-center py-20">
          ...
          <p className="text-slate-505 mt-2">
              ...
              <div className="max-h-[220px] overflow-y-auto pr-1 space-y-4 border-b border-slate-100 dark:border-zinc-850 pb-4">
                {items.map((item, idx) => (
                  <div key={idx} className="flex gap-3 items-center text-sm">
                    <div className="relative w-12 h-12 bg-slate-50 dark:bg-zinc-855 border border-slate-100 dark:border-zinc-800 rounded-lg overflow-hidden shrink-0">
                      <Image
