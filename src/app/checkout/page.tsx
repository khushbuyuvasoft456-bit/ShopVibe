...
import { CheckCircle, CreditCard, ShoppingBag, ShieldCheck, ArrowLeft, Truck } from "lucide-react";
...
export default function CheckoutPage() {
        ...
        <div className="bg-white dark:bg-zinc-900 border border-slate-100 dark:border-zinc-800 rounded-3xl p-8 sm:p-12 shadow-sm space-y-6">
          ...
          <div className="bg-slate-55/70 dark:bg-zinc-850/30 border border-slate-100 dark:border-zinc-850 p-4 rounded-xl text-left text-sm font-semibold space-y-2">
            <div className="flex justify-between">
              ...
              <span className="text-slate-900 dark:text-zinc-150 font-bold">{placedOrder.id}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-slate-455">Order Date:</span>
              <span className="text-slate-900 dark:text-zinc-150">{placedOrder.date}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-slate-455">Shipping Method:</span>
              <span className="text-slate-900 dark:text-zinc-150">Standard Delivery (3-5 Days)</span>
            </div>
  ...
  if (items.length === 0) {
    return (
      <div className="pb-20 max-w-md mx-auto text-center py-20">
        ...
        <h2 className="text-2xl font-bold text-slate-800 dark:text-zinc-200">No items to checkout</h2>
        <p className="text-slate-500 mt-2">Add some products to your cart before proceeding to checkout.</p>
        <Link
          href="/products"
  ...
  return (
    <div className="pb-20">
      ...
      <form onSubmit={handlePlaceOrder} className="grid grid-cols-1 lg:grid-cols-12 gap-8 mt-6">
