...
const TESTIMONIALS: Testimonial[] = [
  {
    ...
    quote: "The Pro Wireless Headphones blew my expectations away. Fast delivery, perfect noise isolation, and a deep bass that doesn't overwhelm. The dark mode theme of this website is incredibly smooth too!",
    rating: 5,
  ...
  },
  {
    ...
    name: "Sarah Miller",
    role: "Verified Buyer",
    quote: "I bought the Ceramic Mug Set and the Organic Vitamin C Serum. Both products arrived in pristine packaging. Customer service helped me update my shipping address instantly. Highly professional site.",
    rating: 5,
  ...
  },
  {
    ...
    role: "Fitness Coach",
    quote: "The alignment lines on the Yoga Mat are a game changer. The TPE material is truly non-slip, even during sweaty sessions. Ordering was a breeze with the 1-click add to cart buttons.",
    rating: 4,
  ...
  },
  {
    ...
    quote: "The shipping was incredibly fast, and the packaging was super premium. The fitness tracker matches all my styling choices perfectly. I'll definitely be buying my summer gifts from here!",
    rating: 5,
  ...
  },
  {
    ...
    name: "David Vance",
    role: "Audio Producer",
    quote: "I tested the soundstage on the Pro Wireless ANC headphones. For this price, the response curve is exceptionally flat, providing excellent mids. The website's search filters make shopping efficient.",
    rating: 5,
  ...
  },
  {
    ...
    role: "Home Stylist",
    quote: "Minimalist aesthetics at its best! The Espresso Machine and Ceramic Mug Set are now beautiful statement pieces on my counter. Excellent checkout experience with instant details validation.",
    rating: 5,
    ...
    <section className="py-12 sm:py-16 overflow-hidden">
      <div className="text-center max-w-2xl mx-auto mb-12">
        ...
        <p className="text-sm text-slate-500 dark:text-zinc-400 mt-2">
          Real feedback from verified purchasers about our products and shopping experience.
        </p>
      </div>
